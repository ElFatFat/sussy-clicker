...
let manualSaveElement = document.getElementById(
    "manualSaveImg"
            ...
            if (canBuyUpgrade(upgrade1Price)) {
                ...
                if (upgrade1lvl == 1) {
                    popup(
                        "img/achievement.png",
                        "Hache Niv. 1",
                        "Une hache c'est bien, mais une hache affutée c'est mieux !"
                    );
                }
                if (upgrade1lvl == 10) {
                    popup(
                        "img/achievement.png",
                        "Hache Niv. 10",
                        "Cette hache est vraiment bien affutée ! Autant prendre un scalpel à ce niveau là..."
                    );
                }
                if (upgrade1lvl == 30) {
                    popup(
                ...
                if (upgrade1lvl == 50) {
                    popup(
                        "img/achievement.png",
                        "Hache Niv. 50",
                        "Vous aimez VRAIMENT les haches, non ?"
                    );
                }
                if (upgrade1lvl == 100) {
                    popup(
                        "img/achievement.png",
                        "Hache Niv. 100",
                        "Ce n'est pas réellement possible datteindre ce niveau. La triche cest mal."
                    );
                }
            }
            break;
            ...
            if (canBuyUpgrade(upgrade2Price)) {
                ...
                if (upgrade2lvl == 1) {
                    popup(
                        "img/achievement.png",
                        "Tronçonneuse Niv. 1",
                        "Les tronçonneuses, c'est bien, mais les tronçonneuses affutées c'est mieux ! (et plus dangereux)"
                    );
                }
                if (upgrade2lvl == 10) {
                    popup(
                        "img/achievement.png",
                        "Tronçonneuse Niv. 10",
                        "VROUM VROUM !!! (et encore plus d'arbres coupés)"
                    );
                }
                if (upgrade2lvl == 30) {
                    popup(
                        "img/achievement.png",
                        "Tronçonneuse Niv. 30",
                        "Encore plus de tronçonneuses ? BIEN SÛR !!!"
                    );
                }
                if (upgrade2lvl == 50) {
                    popup(
                        "img/achievement.png",
                        "Tronçonneuse Niv. 50",
                        "Honnêtement, je n'ai plus aucune idée de quoi mettre comme succès. Bravo ?"
                    );
                }
                if (upgrade2lvl == 100) {
                    popup(
                        "img/achievement.png",
                        "Tronçonneuse Niv. 100",
                        "Toujours plus, oui..."
                    );
                }
            }
            ...
            if (canBuyUpgrade(upgrade3Price)) {
                ...
                if (upgrade3lvl == 1) {
                    popup(
                        "img/achievement.png",
                        "Scierie Niv. 1",
                        "On augmente la production de bois !"
                    );
                }
                if (upgrade3lvl == 5) {
                    popup(
                ...
                if (upgrade3lvl == 20) {
                    popup(
                        "img/achievement.png",
                        "Scierie Niv. 20",
                        "Je suis pas certain qu'il y ait assez de bois dans le monde pour autant de scieries..."
                    );
                }
                if (upgrade3lvl == 50) {
                    popup(
            ...
            if (upgrade4lvl == 0) {
                if (canBuyUpgrade(upgrade4DefaultPrice)) {
                    ...
                    popup(
                        "img/achievement.png",
                        "Clavier >>>> Souris",
                        "Hop hop hop, on appuie sur la touche espace !"
                    );
                }
            }
            break;
        ...
        case 5:
            if (upgrade5lvl == 0) {
                if (canBuyUpgrade(upgrade5DefaultPrice)) {
                    ...
                    popup(
                        "img/achievement.png",
                        "PAR LA PUISSANCE DE STORMBREAKER",
                        "Que les dieux vous bénissent (et que les arbres meurent) !!!"
                    );
                }
            }
            break;
...
function updateAlltimeClicks(): void {
    ...
    if (alltimeClicks == 10) {
        popup(
            "img/achievement.png",
            "10 clics",
            "C'est déjà pas mal ! Allez, on continue de couper du bois !"
        );
    }
    if (alltimeClicks == 100) {
        popup(
            "img/achievement.png",
            "100 clics",
            "Okay, on a un bon rythme là ! Continue comme ça !"
        );
    }
    if (alltimeClicks == 1000) {
        popup(
            "img/achievement.png",
            "1000 clics",
            "Ah bah enfin ! J'ai cru que tu n'allais jamais y arriver !"
        );
    }
    if (alltimeClicks == 10000) {
        popup(
            "img/achievement.png",
            "10k clics",
            "Pauvre sapin, tu as vraiment massacré ce pauvre arbre !"
        );
    }
    if (alltimeClicks == 100000) {
        popup(
            "img/achievement.png",
            "100k clics",
            "Si j'étais toi, j'irai jouer à un autre jeu..."
        );
    }
    if (alltimeClicks == 1000000) {
        popup(
            "img/achievement.png",
            "1M clics",
            "Spectaculaire ! Mais obtenu en trichant :)"
        );
    }
}
...
function updateAlltimeMoney(): void {
    ...
    if (alltimeMoney >= 10000 && achievementMoney1000 == false) {
        ...
        popup(
            "img/achievement.png",
            "10k $",
            "Si seulement être riche était aussi simple !"
        );
    }
...
function popup(img: string, title: string, text: string): void {
